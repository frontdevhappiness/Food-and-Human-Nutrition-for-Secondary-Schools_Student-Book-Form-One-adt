# Food and Human Nutrition for Secondary Schools: Student’s Book Form One — ADT Bundle Reference
...
**Food and Human Nutrition for Secondary Schools: Student’s Book Form One** — This is an English-language secondary school textbook from Tanzania, published by the Tanzania Institute of Education for Form One students, roughly equivalent to lower secondary or early teenage level. It introduces the basics of food and human nutrition, covering food groups, nutrients, balanced meals, kitchen hygiene and safety, fruits and vegetables, beverages and appetisers, pulses, nuts and oil seeds, and proper nutrition linked to health and physical activity. The book takes a practical, competency-based approach, using activities, recipes, illustrations and revision exercises to build everyday life skills, healthy eating habits and awareness of nutrition-related disorders.
...
├── FOOD-AND-HUMAN-NUTRITION--F1.db                    # SQLite database (pipeline state)
├── FOOD-AND-HUMAN-NUTRITION--F1.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg000_im001` |
...
```json
[
  { "section_id": "pg000_sec001", "href": "index.html" },
...
{
  "pg001_gp001_tx001": "",
  "pg000_im001": "Food and Human Nutrition for Secondary Schools. Student’s Book, Form One. Tanzania Institute of Education. The pink and purple cover shows four dishes: a colourful salad, a stew, soup and vegetables. Property of the Government of the United Republic of Tanzania. Not for Sale.",
  "gl001": "absorption",
  "gl001_def": "the process by which the body takes in nutrients from food"
}
```
...
```json
{
  "absorption": {
    "word": "absorption",
    "definition": "the process by which the body takes in nutrients from food",
    "variations": ["absorption","absorb","absorbed"],
    "emoji": "⬇️🥗"
  }
}
```
...
```json
{
  "title": "Food and Human Nutrition for Secondary Schools: Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<html lang="en-GB">
<head>
    <meta name="title-id" content="pg009_sec001" />      <!-- section identity -->
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
                 data-section-id="pg009_sec001">
            <!-- Images use relative paths and carry data-id for alt text lookup -->
            <img data-id="pg000_im001" src="images/pg000_im001.png" ...>
...
| Original PDF | `FOOD-AND-HUMAN-NUTRITION--F1.pdf` |
| Pipeline database | `FOOD-AND-HUMAN-NUTRITION--F1.db` (SQLite) |
